...
import { useReportExportTDMutation } from 'src/infra/api/access-service/report'
...
export function ExportTD() {
  const userPermissions = useTypedSelector(selectUserPermissions)
  const [openDialog, setOpenDialog] = useState(false)
  const [exportTD, { isLoading }] = useReportExportTDMutation()
  ...
  return (
    <>
      <Button
        ...
        disabled={!checkPermissionAnyOf(userPermissions, [Permission.ExportTD])}
      >
        TDĐ
      </Button>
      <ExportDialog
