...
import { useReportExportPapMutation } from 'src/infra/api/access-service/report'
...
export type ExportPapButtonProps = {
  origins: BranchResponseDto[]
}

export function ExportPapButton(props: ExportPapButtonProps) {
  ...
  const [exportPap, { isLoading }] = useReportExportPapMutation()
