...
import { useReportExportCtmMutation } from 'src/infra/api/access-service/report'
...
export type ExportCTMButtonProps = {
  origins: BranchResponseDto[]
}

export function ExportCTMButton(props: ExportCTMButtonProps) {
