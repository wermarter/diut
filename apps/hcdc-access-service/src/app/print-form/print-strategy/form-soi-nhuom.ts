...
@Injectable()
export class SamplePrintFormSoiNhuomStrategy extends AbstractSamplePrintStrategy {
  static readonly type = PrintTemplate.FormSoiNhuom
  ...
  constructor(
    ...
    super(sampleRepository, testCategoryRepository, PrintTemplate.FormSoiNhuom)
  }
}
